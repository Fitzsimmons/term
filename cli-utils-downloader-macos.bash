...
function download_url() {
	echo $(curl -L -s $(releases_url $1) | jq -r '.assets | map(select(.name | contains("x86_64-apple-darwin")))[0].browser_download_url')
}
...
gfind $extraction_dir -type f -executable -exec mv {} $HOME/bin \;
